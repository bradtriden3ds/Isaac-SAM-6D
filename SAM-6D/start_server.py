...
sam6d_models = {"detector": None, "estimator": None, "batch": None}
...
def run_sam6d(
    ...
    return {"message": "SAM-6D inference completed.", "image_segmentation_time_cost": image_segmentation_time_cost}
